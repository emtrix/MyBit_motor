...
namespace MyBit {
     ...
     * @param index
     */   
    //% blockId=MyBit_RGB_Program block="RGB_Program"
    //% weight=99
    //% blockGap=10
    ...
    //% blockId=MyBit_Music block="Music|%index"
    //% weight=98
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=MyBit_Servo block="Servo(180°)|num %num|value %value"
    //% weight=97
    //% blockGap=10
    ...
    //% blockId=MyBit_Servo2 block="Servo(270°)|num %num|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=MyBit_Servo3 block="Servo(360°)|num %num|pos %pos|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=MyBit_MotorRun block="Motor|%index|speed(-255~255) %speed"
    //% weight=93
    ...
    //% blockId=MyBit_MotorRunDual block="Motor|%motor1|speed %speed1|%motor2|speed %speed2"
    //% weight=92
    //% blockGap=50
    ...
    //% blockId=MyBit_StepperDegree block="Stepper Motor(28BYJ-48) |%index|degree %degree"
    //% weight=90
    ...
    //% blockId=MyBit_MotorStopAll block="Motor Stop All"
    //% weight=91
    //% blockGap=50
    ...
    //% blockId=MyBit_StepperTurn block="Stepper Motor(28BYJ-48) |%index|turn %turn|circle"
    //% weight=89
    ...
    //% blockId=MyBit_StepperDual block="Dual Stepper Motor(Degree) |M1 %degree1| M2 %degree2"
    //% weight=88
    ...
    //% blockId=MyBit_PWMOFF block="PWM OFF|%index"
    //% weight=87
